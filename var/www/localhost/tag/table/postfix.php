...
<head>
	...
	<script type="text/javascript" src="../js/column.js" charset="UTF-8"></script>
...
<body>
	<div class="container" style="width:100%;">  
		...
		<br/> 
		<!-- Форма скрытия столбца -->
		<div class="vibor">
		<form action="" method="post" id="select">
			<input name="column" type="checkbox" value="3" /> Скрыть id 
			<input name="column" type="checkbox" value="4" /> Скрыть id2 
			<input name="column" type="checkbox" value="5" /> Скрыть msgid 
			<input name="column" type="checkbox" value="10" /> Скрыть ip2
		</form>
		</div>
		<div>
		...
		<!-- Создание таблицы -->
		<div id="order_table" width = "window.innerWidth">  
			 <ul class="pagination pager" id="myPager"></ul>			 
		</div>  
	</div> 
</body>
</html>
<script type="text/javascript" src="../js/postab.js" charset="UTF-8"></script>